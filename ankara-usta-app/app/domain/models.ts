...
export const disputeStatuses=['opened','triage','awaiting_evidence','counterparty_response','investigation','resolution_proposed','notified','appealed','closed','dismissed'] as const;
