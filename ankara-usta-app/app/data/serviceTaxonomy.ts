...
export const services: Service[] = [
  ...
  {id:'tv-duvar-montaji',categoryId:'montaj',name:'TV Duvar Montajı',slug:'tv-duvar-montaji',aliases:['televizyon asma','tv askı aparatı'],deliveryModel:'package',popularRank:3},
  {id:'kornis-perde-montaji',categoryId:'montaj',name:'Korniş Montajı',slug:'kornis-perde-montaji',aliases:['perde rayı','korniş takma'],deliveryModel:'package',popularRank:9},
  {id:'raf-tablo-montaji',categoryId:'montaj',name:'Raf veya Tablo Montajı',slug:'raf-tablo-montaji',aliases:['duvara raf','tablo asma'],deliveryModel:'package',popularRank:2},
  {id:'avize-montaji',categoryId:'montaj',name:'Avize Montajı',slug:'avize-montaji',aliases:['lamba takma','aydınlatma montajı'],deliveryModel:'package',popularRank:8},
  {id:'elektrik-arizasi',categoryId:'elektrik',name:'Elektrik Arızası',slug:'elektrik-arizasi',aliases:['elektrik yok','kısa devre'],deliveryModel:'inspection',popularRank:7},
  ...
  {id:'musluk-degisimi',categoryId:'tesisat',name:'Musluk Değişimi',slug:'musluk-batarya-degisimi',aliases:['musluk damlatıyor','batarya değişimi'],deliveryModel:'package',popularRank:6},
  ...
  {id:'tek-oda-boya',categoryId:'boya-tadilat',name:'Tek Oda Boya',slug:'tek-oda-boya',aliases:['oda boyatma','duvar boyası'],deliveryModel:'quote'},
  ...
  {id:'bahce-kapisi',categoryId:'kaynak-demir',name:'Bahçe Kapısı Onarımı',slug:'bahce-kapisi-onarimi',aliases:['demir kapı bozuk','kapı kaynağı'],deliveryModel:'inspection',popularRank:5},
  ...
  {id:'ozel-demir-imalati',categoryId:'kaynak-demir',name:'Özel Demir İmalatı',slug:'ozel-demir-imalati',aliases:['demir imalat','özel kaynak işi'],deliveryModel:'inspection',popularRank:4},
  {id:'ev-temizligi',categoryId:'temizlik',name:'Ev Temizliği',slug:'ev-temizligi',aliases:['gündelikçi','ev temizletme','haftalık temizlik'],deliveryModel:'package'},
