...
--    - renovation.png
-- 
-- 2. Aşağıdaki sorguda yer alan 'YOUR_PROJECT_REF' ifadesini
...
values
  ...
  (
    ...
    'Kaynak ve metal',
    'Yenimahalle, Ankara',
    'https://YOUR_PROJECT_REF.supabase.co/storage/v1/object/public/gallery/hinge_after.png',
    'https://YOUR_PROJECT_REF.supabase.co/storage/v1/object/public/gallery/hinge_before.png',
    'Kopan Paslı Menteşe',
  ...
  (
    ...
    'Kaynak ve metal',
    'Çankaya, Ankara',
    'https://YOUR_PROJECT_REF.supabase.co/storage/v1/object/public/gallery/railing_after.png',
    'https://YOUR_PROJECT_REF.supabase.co/storage/v1/object/public/gallery/railing_before.png',
  ...
  (
    ...
    'Kaynak ve metal',
    'Etimesgut, Ankara',
    'https://YOUR_PROJECT_REF.supabase.co/storage/v1/object/public/gallery/shelf_after.png',
    'https://YOUR_PROJECT_REF.supabase.co/storage/v1/object/public/gallery/shelf_before.png',
  ...
  (
    ...
    'Boya ve badana',
    'Keçiören, Ankara',
    'https://YOUR_PROJECT_REF.supabase.co/storage/v1/object/public/gallery/painting.png',
    null,
    'Öncesi',
    'Sonrası',
  ...
  (
    ...
    'İnşaat ve tadilat',
    'Yenimahalle, Ankara',
    'https://YOUR_PROJECT_REF.supabase.co/storage/v1/object/public/gallery/renovation.png',
    null,
    'Öncesi',
    'Sonrası',
  ...
  (
    ...
    'Keçiören, Ankara',
    'https://YOUR_PROJECT_REF.supabase.co/storage/v1/object/public/gallery/sliding_gate_after.png',
    'https://YOUR_PROJECT_REF.supabase.co/storage/v1/object/public/gallery/sliding_gate_before.png',
  ...
  (
    ...
    'Gölbaşı, Ankara',
    'https://YOUR_PROJECT_REF.supabase.co/storage/v1/object/public/gallery/gate_motor_after.png',
    'https://YOUR_PROJECT_REF.supabase.co/storage/v1/object/public/gallery/gate_motor_before.png',
    'Manuel Demir Kapı',
  ...
  (
    ...
    'Çankaya, Ankara',
    'https://YOUR_PROJECT_REF.supabase.co/storage/v1/object/public/gallery/smart_lock_after.png',
    'https://YOUR_PROJECT_REF.supabase.co/storage/v1/object/public/gallery/smart_lock_before.png',
    'Eski Manuel Kilit',
